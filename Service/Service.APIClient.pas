...
begin
  try
    ...
    on E: EIdHTTPProtocolException do
      TDialogService.ShowMessage('O servidor retornou um erro:'+#10#13+
        'Código do erro: '+IntToStr(E.ErrorCode)+#10#13+'Mensagem: '+E.ErrorMessage);
    on E: EIdSocketError do
      TDialogService.ShowMessage('Erro de conexão com o servidor:'+#10#13+E.Message);
    on E: Exception do
      TDialogService.ShowMessage('Erro inesperado: '+E.Message);
  end;
end;
